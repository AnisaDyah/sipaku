    ...
    <main>
        <div class="container-fluid">
            ...
            <div class="card mb-4">
                ...
                <button type="button" name="button" class="btn btn-warning pull-right" data-toggle="modal" data-target="#modal-cetak"> <i class="fa fa-print"></i> Cetak Riwayat Diagnosa</button>
                </div>
                <div class="card-body">
