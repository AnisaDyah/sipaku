                ...
                <div class="x_panel">
                  ...
                  <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <?php foreach ($list as $data => $value) { ?>
                        ...
                        <?php if($this->session->userdata('id_user_level') == '1'): ?>
                          <td>
                              <?php echo form_open('Pegawai/destroy/'.$value->id_pegawai)  ?>
                              <a class="btn btn-info" href="<?php echo base_url('Pegawai/edit/'.$value->id_pegawai) ?>">
