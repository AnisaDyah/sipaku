...
class Perhitungan_agustin extends CI_Controller
{
	...
	function __construct()
	{
		...
		$this->load->model('M_Perhitungan_agustin');
	}
	...
	public function index()
	{
		...
		$db_kasus = $this->M_Perhitungan_agustin->joinPerhitungan();
		...
		$this->load->view('hasilKonsultasi_agustin', $data);
	}
}
